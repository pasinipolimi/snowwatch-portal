...
elseif (strlen( $_POST['phpro_username']) > 10 || strlen($_POST['phpro_username']) < 3)
{
    $message = 'Incorrect Length for Username';
}
/*** check the password is the correct length ***/
elseif (strlen( $_POST['phpro_password']) > 10 || strlen($_POST['phpro_password']) < 3)
{
...
else
{
    ...
    /*** mysql username ***/
    $mysql_username = 'swadmin';

    /*** mysql password ***/
    $mysql_password = 'swadmin';

    /*** database name ***/
    $mysql_dbname = 'swportal';
